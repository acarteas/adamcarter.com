...
class Home extends Component {
   ...
   fetchWorkHistory() {
      ...
      this.session_manager.makeUrlRequest(work_endpoint, result => {
   ...
   fetchEducationHistory() {
      ...
      this.session_manager.makeUrlRequest(education_endpoint, 
      result => { this.setState({ education_history: result.data.response }); });
   }
   ...
   fetchFieldData() {
      ...
      for (const field of fields) {
         ...
         this.session_manager.makeUrlRequest(endpoint, result => {
